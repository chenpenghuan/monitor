...
class Chart{
  ...
  */
  ...
  static function createcolumnar($title,$data=array(),$size=40,$height=100,$width=80,$legend=array()){
  	    //载入文件
		require (dirname(__FILE__)."/../../Vendor/Jpgraph/jpgraph.php");
		require (dirname(__FILE__)."/../../Vendor/Jpgraph/jpgraph_bar.php");
		// Some data
		// Create the graph and setup the basic parameters 
		$graph = new Graph($width,$height,'auto');	
		$graph->img->SetMargin(40,30,100,40);
  ...
  */
  ...
  function createmonthline($title,$data=array(),$size=40,$height=100,$width=80,$legend=array()){
	require (dirname(__FILE__)."/../../Vendor/Jpgraph/jpgraph.php");
	require (dirname(__FILE__)."/../../Vendor/Jpgraph/jpgraph_line.php");
