            ...
            switch ($_POST['act']) {
                ...
                case 'add':
                    ...
                    $str_form = '<form class="form-horizontal" role="form" style="padding-left:10%;padding-top:3%;width:80%;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea style="font-size:0.3cm;word-wrap: break-word;word-break:break-all;" type="text" class="form-control" id="itm_from" placeholder="请输入菜单字段配置，json格式，也可以在字段新建完成后设置"></textarea>
                                </div>
                            </div>
                            -->
                            <div class="form-group">
                ...
                case 'saveedit':
                    ...
                    try {
                        ...
                        echo 'json数据错误，请检查！' . $e->getMessage();
                        exit();
                    }
