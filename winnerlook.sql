...
--
-- Current Database: `winnerlook`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `winnerlook` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `warn_conf` (
  ...
  `warn_type` varchar(30) DEFAULT NULL,
  `warn_prog` varchar(30) DEFAULT NULL,
  `warn_conf` varchar(30) DEFAULT NULL,
  `warn_send` varchar(240) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-09-07 12:33:07
